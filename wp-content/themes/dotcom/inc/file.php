...
$result = mysql_query("SELECT Resolution FROM CallTypes WHERE LOB = 'fxrs' AND Type = 'FSMS'"); 
...
$result = mysql_query("SELECT Resolution FROM CallTypes WHERE LOB = 'FXRS' AND Type = 'WIS'"); 
...
$result = mysql_query("SELECT Resolution FROM CallTypes WHERE LOB = 'Café' AND Type = 'Café'"); 
...
$result = mysql_query("SELECT Resolution FROM CallTypes WHERE LOB = 'FXRS' AND Type = 'FXCT'"); 
